...
//    due to the fact that I am using @Published for the variables of class the class no longer comply with Codable protocol
//    therefor I have to add Coding keys, encode and custom init with decoding
